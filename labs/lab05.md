...
![UC-Register Account Collaboration](images/UC-01-Register Account.png)

#### UC-Create Post

![UC-Create Post Collaboration](images/UC-02-Create Post.png)

#### UC-Admin Ban User

![UC-Admin Ban User Collaboration](images/UC-03-Admin Ban User.png)

### VOPC Diagrams

#### UC-Register Account

![UC-Register Account VOPC](images/UC-Register Account VOPC.png)

#### UC-Create Post

![UC-Create Post VOPC](images/UC-Create Post VOPC.png)

#### UC-Admin Ban User

![UC-Admin Ban User VOPC](images/UC-Admin Ban User VOPC.png)
